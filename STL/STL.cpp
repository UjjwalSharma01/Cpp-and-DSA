/* CONCEPTS
    ...
    // pair - > datatype - > structure -> name -> data
...
/*******************************************************************************************************************************************************************************************
   ...
   when we are storing integer, instead of storing them individually, we can also store them in pairs using pair container */
    // PAIR EXAMPLE
...
VECTOR IS A CONTAINER (STORES DATA) -> WHICH IS DYNAMIC IN NATUE (YOU CAN CHANGE THE SIZE WHEN REQUIRED)
